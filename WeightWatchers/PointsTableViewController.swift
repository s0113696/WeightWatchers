...
class PointsTableViewController: UITableViewController,UISearchResultsUpdating, UISearchBarDelegate, UISearchControllerDelegate {
    ...
    func updateSearchResultsForSearchController(searchController: UISearchController)
    {
        ...
        let searchPredicate = NSPredicate(format: "todaysdate CONTAINS[c] %@", searchController.searchBar.text!)
    ...
    func loaddb()
    {
        ...
        let fetchRequest = NSFetchRequest(entityName:"MyLog")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (self.resultSearchController.active) {
            ...
            let stringdate = formatter.stringFromDate(person.valueForKey("todaysdate") as! NSDate)
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        //**Begin Copy**
        if segue.identifier == "ShowPoints" {
